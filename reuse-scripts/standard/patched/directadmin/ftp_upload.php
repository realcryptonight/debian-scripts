...
upload_file_ftps()
{
	...
	${CURL} --config ${CFG} --silent --ssl --insecure -k --silent --show-error --ftp-pasv --ftp-create-dirs --upload-file $ftp_local_file ftps://$ftp_ip:${PORT}/$ftp_path$ftp_remote_file 2>&1
	RET=$?
